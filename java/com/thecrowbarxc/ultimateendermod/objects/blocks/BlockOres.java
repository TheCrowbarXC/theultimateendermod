...
import com.thecrowbarxc.ultimateendermod.objects.blocks.item.ItemBlockVariants;
...
import com.thecrowbarxc.ultimateendermod.util.interfaces.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName
{
	...
	public BlockOres(String name, String dimension) 
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.ENDERIUM));
